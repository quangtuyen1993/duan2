...
public class HomeFragmentDirections {
  ...
  @NonNull
  public static ActionHomeFragmentToBookTitleFragment actionHomeFragmentToBookTitleFragment(
      @NonNull Book book) {
    return new ActionHomeFragmentToBookTitleFragment(book);
  }

  public static class ActionHomeFragmentToBookTitleFragment implements NavDirections {
    private final HashMap arguments = new HashMap();

    private ActionHomeFragmentToBookTitleFragment(@NonNull Book book) {
      if (book == null) {
    ...
    @NonNull
    public ActionHomeFragmentToBookTitleFragment setBook(@NonNull Book book) {
      if (book == null) {
        throw new IllegalArgumentException("Argument \"book\" is marked as non-null but was passed a null value.");
      }
      this.arguments.put("book", book);
    ...
    public int getActionId() {
      return R.id.action_homeFragment_to_bookTitleFragment;
    }
    ...
    public boolean equals(Object object) {
      ...
      ActionHomeFragmentToBookTitleFragment that = (ActionHomeFragmentToBookTitleFragment) object;
    ...
    public String toString() {
      return "ActionHomeFragmentToBookTitleFragment(actionId=" + getActionId() + "){"
          + "book=" + getBook()
          + "}";
    }
  }
