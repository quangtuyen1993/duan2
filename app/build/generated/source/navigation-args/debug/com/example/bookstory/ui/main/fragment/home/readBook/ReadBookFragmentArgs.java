...
public class ReadBookFragmentArgs implements NavArgs {
  private final HashMap arguments = new HashMap();

  private ReadBookFragmentArgs() {
  }

  private ReadBookFragmentArgs(HashMap argumentsMap) {
    this.arguments.putAll(argumentsMap);
  }

  @NonNull
  @SuppressWarnings("unchecked")
  public static ReadBookFragmentArgs fromBundle(@NonNull Bundle bundle) {
    ReadBookFragmentArgs __result = new ReadBookFragmentArgs();
    bundle.setClassLoader(ReadBookFragmentArgs.class.getClassLoader());
  ...
  public boolean equals(Object object) {
    ...
    ReadBookFragmentArgs that = (ReadBookFragmentArgs) object;
  ...
  public static class Builder {
    ...
    public Builder(ReadBookFragmentArgs original) {
    ...
    @NonNull
    public ReadBookFragmentArgs build() {
      ReadBookFragmentArgs result = new ReadBookFragmentArgs(arguments);
      return result;
    }
